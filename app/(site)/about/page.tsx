    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <div className="mb-12 text-center">
          <h2 className="font-heading text-[clamp(1.5rem,5vw,2.25rem)] font-bold uppercase text-secondary md:text-4xl">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-start">
          ...
          <div className="space-y-4 text-gray-700">
            <h3 className="font-heading text-lg font-bold uppercase text-secondary lg:text-xl">A Legacy of Excellence</h3>
            <p>
            ...
            <div className="grid grid-cols-1 gap-4 pt-6 sm:grid-cols-3">
              {[
                ...
                <div key={s.l} className="rounded-xl bg-gray-100 p-4 text-center">
                  <div className="font-heading text-xl font-bold text-primary sm:text-2xl">{s.n}</div>
      ...
      <section className="bg-gray-100 py-16">
        <div className="mx-auto max-w-6xl px-4">
          <div className="mb-10 text-center">
            <h2 className="font-heading text-2xl font-bold uppercase text-secondary md:text-3xl">Our Core Values</h2>
            ...
            {[
              {
                icon: "🏆",
                t: "Excellence",
                d: "We strive for excellence in every class, every technique, and every interaction.",
              },
              {
                icon: "🤝",
                t: "Respect",
                d: "Respect for instructors, training partners, and yourself is the foundation of practice.",
              },
              {
                icon: "💪",
                t: "Discipline",
                d: "Consistency and dedication separate those who dream from those who achieve.",
              },
              {
                icon: "❤️",
                t: "Community",
                d: "We&apos;re more than a gym — we&apos;re a family. Everyone reaches their potential here.",
              },
            ].map((v) => (
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <div className="mb-10 text-center">
          <h2 className="font-heading text-2xl font-bold uppercase text-secondary md:text-3xl">Our Facility</h2>
      ...
      <section className="bg-gradient-to-br from-secondary to-[#1a2a42] px-4 py-16 text-center text-white">
        <div className="mx-auto max-w-2xl">
          <h2 className="font-heading text-2xl font-bold uppercase md:text-3xl">Ready to Join Our Community?</h2>
          <p className="mt-4 text-white/85">
            Experience the difference 25 years of excellence makes. Your first week is completely free.
          </p>
          <Link
            href="/free-trial"
            className="mt-8 inline-flex w-full items-center justify-center rounded-lg bg-white px-8 py-3 font-semibold text-secondary transition hover:bg-gray-100 sm:w-auto"
          >
